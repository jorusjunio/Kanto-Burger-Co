      ...
      <section className="relative overflow-hidden border-b border-orange-900/10">
        ...
        <div className="mx-auto grid max-w-6xl gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:py-8">
          <div className="space-y-4">
            ...
            <h1 className="food-heading max-w-3xl text-3xl leading-none sm:text-5xl">
              Pick your burger. Stack the sides. Checkout in minutes.
            </h1>
            <p className="max-w-xl text-sm font-medium leading-6 text-orange-950/70">
              Browse Kanto Burger Co.&apos;s menu, check stock availability,
              and build your order for pickup or delivery.
            </p>
            <div className="grid max-w-lg gap-3 text-[13px] font-bold text-orange-950/70 sm:grid-cols-3">
          ...
          <div className="relative min-h-[200px] overflow-hidden rounded-lg border border-white/70 bg-red-700 shadow-xl shadow-orange-950/10 sm:min-h-[260px]">
            <Image
